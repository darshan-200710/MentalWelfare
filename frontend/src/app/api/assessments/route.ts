...
const DEFAULT_QUESTIONS = [
  {
    code: "MOOD_TODAY",
    questionText: "How would you describe your overall mood and morale today?",
    questionType: "single_choice",
    options: JSON.stringify([
      { value: "excellent", label: "Excellent - Feeling great", score: 0 },
      { value: "good", label: "Good - Managing well", score: 1 },
      { value: "fair", label: "Fair - Getting by", score: 2 },
      { value: "poor", label: "Poor - Struggling today", score: 4 },
      { value: "critical", label: "Very Poor - Need support", score: 5 },
    ]),
    scoringMeta: "{}",
  ...
  {
    code: "DEPLOYMENT_STRESS",
    questionText: "Has your current deployment or posting been more stressful than usual?",
    questionType: "single_choice",
    options: JSON.stringify([
      { value: "normal", label: "No, about average", score: 0 },
      { value: "slightly", label: "Slightly more stressful", score: 2 },
      { value: "significantly", label: "Significantly more stressful", score: 4 },
      { value: "overwhelming", label: "Extremely overwhelming", score: 5 },
    ]),
    scoringMeta: "{}",
